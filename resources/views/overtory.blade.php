...
<html lang="en">
  ...
  <body>
    ...
    <!-- nama website -->
    <p class="text-center font-weight-bold underline mx-auto">OVERTORY</p>
    <!-- akhir nama website -->
    ...
    <div class="container-fluid mt-5 px-5" id="container-content">
        <div class="py-4">
            ...
            <h2 class="font-weight-bold text-center">OVERTORY/h2>
        </div>
        ...
        <div class="px-5 mx-5 mt-5 text-justify" id="container-text">
            <span class="font-weight-bold color-text">Overtory</span>
            <p class="color-text text-justify">&emsp; Overtory is a food management app developed in collaboration with a client from Upwork. It helps users track food expiration, categorizing items as expiring soon, expired, or long expired. The app features local notifications that remind users 3 days before expiration and on the expiration day.
                ...
                Built with Flutter, utilizing GetX for state management and Clean Architecture (DDD), Overtory ensures scalability and maintainability. The app is available on iOS and Android.</p>
        </div>
    </div>
    <!-- akhir content -->
