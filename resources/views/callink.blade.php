...
<html lang="en">
  ...
  <body>
    ...
    <!-- nama website -->
    <p class="text-center font-weight-bold underline mx-auto">CALLINK</p>
    <!-- akhir nama website -->
    ...
    <div class="container-fluid mt-5 px-5" id="container-content">
        <div class="py-4">
            ...
            <h2 class="font-weight-bold text-center">CALLINK</h2>
        </div>
        ...
        <div class="px-5 mx-5 mt-5 text-justify" id="container-text">
            <span class="font-weight-bold color-text">CALLINK</span>
            <p class="color-text text-justify">&emsp; Callink is an messaging application designed to streamline team communication by consolidating all messages, work items, and tools into a single platform. It offers features such as easy-to-use messaging, private and public channels, message threads, rapid file transfer, and instant voice and video call access. The app emphasizes simplicity and security, utilizing end-to-end encryption to ensure that only you and your intended recipients can access your conversations.</p>
        </div>
    </div>
    <!-- akhir content -->
