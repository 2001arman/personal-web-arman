...
<html lang="en">
  ...
  <body>
    ...
    <!-- nama website -->
    <p class="text-center font-weight-bold underline mx-auto">SIMATALIA</p>
    <!-- akhir nama website -->
    ...
    <div class="container-fluid mt-5 px-5" id="container-content">
        <div class="py-4">
            ...
            <h2 class="font-weight-bold text-center">Website Kecamatan Tana Lia</h2>
        </div>
